...
export default function Paint({
    ...
    const handleDrawStart = useCallback((e) => {
        ...
        setDrawing(true);
    }, [canvasRef.current, currentCommand, currentColor, currentLineWidth, currentPlugins]);
    const handleDrawing = useCallback((e) => {
        ...
        setDrawing(true);
    }, [canvasRef,currentCommand, currentColor, currentLineWidth, drawing, currentPlugins]);
